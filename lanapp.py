...
# Form implementation generated from reading ui file 'Lan App.ui'
#
# Created: Sun Feb 08 15:22:46 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit_chat = QtGui.QTextEdit(self.tab)
        self.textEdit_chat.setObjectName(_fromUtf8("textEdit_chat"))
        self.gridLayout_4.addWidget(self.textEdit_chat, 0, 0, 1, 4)
        ...
        QtCore.QObject.connect(self.pushButton_6, QtCore.SIGNAL(_fromUtf8("clicked()")), self.textEdit_chat.clear)
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), self.chat)
        #QtCore.QObject.connect(self.pushButton_7, QtCore.SIGNAL(_fromUtf8("clicked()")), self.send)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_15.setText(_translate("MainWindow", "127.0.0.1", None))
        self.lineEdit_14.setText(_translate("MainWindow", "Anonymous", None))
    ...
    def chat(self):
    	user_name = str(self.lineEdit_14.text())
    	host_name = str(self.lineEdit_15.text())
    	user_text = str(self.textEdit_chat.toPlainText())
    	self.client = ChatClient(self,user_name,host_name, 5000)
    	self.client.cmdloop()
    def send(self):
    	self.client.cmdloop()
